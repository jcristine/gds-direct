		...
		value: function _renderer() {
			...
			if (this.state['pqToShow']) {
				...
				this.state['pqToShow'].result.map(function (pq) {
					...
					container.appendChild((0, _dom2.default)('strong.label label-grey m-r-sm', { innerHTML: 'Selling: ' + pq['selling'] }));

					container.appendChild((0, _dom2.default)('strong.label label-grey  m-r-sm', { innerHTML: 'NET: ' + pq['net'] }));

					container.appendChild((0, _dom2.default)('strong.label label-mozilla added-by', { innerHTML: pq['addedByGroupLabel'] }));

					container.appendChild((0, _dom2.default)('div.m-t-sm', {}));
