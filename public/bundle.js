	...
	var Terminal = function () {
		...
		_createClass(Terminal, [{
			...
			value: function create() {
				...
				if (this.params.split == 1) {
					this.menu.appendChild((0, _buttons.fullScreen)().make(function () {
						Main.full();
					}));
				}
