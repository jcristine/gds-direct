...
/***/ function(module, exports, __webpack_require__) {
	...
	Terminal.create = function () {
		...
		var withSplit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
	
		var TerminalInst = document.createElement('div');
		TerminalInst.className = className;
	
		var Menu = document.createElement('div');
		Menu.className = 'text-right wrapper-sm menu';
	
		Menu.appendChild((0, _buttons.bufferBtn)().make());
	
		if (withSplit == 1) {
			Menu.appendChild(_buttons.splitBtn);
	
			_buttons.splitBtn.addEventListener('click', function (e) {
				!SplitScreen ? _this.split() : _this.unSplit();
			});
		}
	
		TerminalInst.appendChild(Menu);
		var plugin = _terminal2.default.init(TerminalInst);
	...
	Terminal.main = function () {
		...
		MainScreen.style.height = _constants.TERMINAL_HEIGHT;
	...
	Terminal.split = function () {
		...
		MainScreen.style.height = _constants.TERMINAL_SPLIT_HEIGHT;
		SplitScreen.style.height = _constants.TERMINAL_SPLIT_HEIGHT;
		return SplitScreen;
	};
	...
	Terminal.render = function () {
		...
		document.getElementById('sideMenu').appendChild(_sideMenu2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sabreSession = __webpack_require__(8);
	...
	var terminal = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _requests = __webpack_require__(10);
	...
	exports.default = function () {
		...
		return {
			...
			startSession2: function startSession2() {
...
/***/ function(module, exports) {
	...
	// export const END_POINT_URL	 		= '/api/js/sabre-terminal';
	// export const END_POINT_URL	 		= 'http://fpe.sjager.php7.dyninno.net/api/js/sabre-terminal';
	var END_POINT_URL = exports.END_POINT_URL = 'http://intranet.dyninno.net/~artur/CMS1ee/?id=sabre/terminal&her=1';
	// export const END_POINT_URL	 		= 'https://sfpe.dyninno.net/api/js/sabre-terminal';
...
/***/ function(module, exports) {
	...
	function bufferBtn() {
		return {
			make: function make(terminalPlugin) {
