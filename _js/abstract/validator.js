define([
	...
	validator.extend('notBlank', function (str) {
...
//	});
	...
	validator.extend('selectNotZero', function (str) {
		return str != 0
	});
	...
	validator.extend('blankOrLetters', function (str) {
		if (!str) return true;
		return !validator.isAlpha(str);
	});

	validator.extend('blankOrEmail', function (str) {
		var
            whitelist = [
	...
	validator.extend('containsNot', function (str, seed) {
		if (!str) return true;
		return !validator.contains(str.toLowerCase(),seed);
	});

	validator.extend('minLength', function (str, seed) {
