...
class SessionStateProcessorTest extends require('klesun-node-tools/src/Transpiled/Lib/TestCase.js') {
	provideCalledCommands() {
		...
		sessionRecords.push({
			"title": "for some reason did not detect 'ATTN*VERIFY BOOKING CLASS' as error... possibly the issue is outside the UpdateState_{gds}.js, as very similar issue happened in Amadeus",
			"initialState": {
				"gds": 'sabre',
				"area": "A",
				"pcc": "C5VD",
				"recordLocator": "",
				"canCreatePq": true,
				"scrolledCmd": "WPP1ADT/1C05¥MCAD",
				"pricingCmd": "WPNC¥MCAD",
