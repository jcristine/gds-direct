...
class RunCmdRqTest extends require('klesun-node-tools/src/Transpiled/Lib/TestCase.js') {
		...
		$list.push({
			input: {
				...
				cmdRequested: [
					...
					"3 QF2142Q 10FEB ADLKGC HK2  1050A 1125A *         MO   E  1    ",
					"        OPERATED BY QANTASLINK - EASTERN AUSTRALIA A/L         ",
					"4 QF1016I 24FEB HBAMEL HK2   550P  710P *         MO   E  2    ",
					"5 QF  49Q 24FEB MELSFO HK2  1035P  545P *         MO   E  2    ",
					"6 AC 561Q 25FEB SFOYVR SS2   620A  848A *         TU   E      ",
				].join('\n'),
			},
			output: {
				calledCommands: [
					{
						...
						"output": [
							"/$--- MSC SFP ---",
							"RP/SFO1S2195/",
							"  1  QF 050 Q 08FEB 6*SFOMEL DK2   815P 645A 10FEB  E  0 789 DR",
							"     MANDATORY NAME GENDER DOB REQMTS REFR US SECURE",
							"     FLIGHT PLUS MANDATORY US VISA REQMTS REFR ESTA",
							"     VISIT QANTAS.COM FOR ELIGIBILITY AND INSTRUCTION",
							"     ADV PAX WWW.SMARTRAVELLER.GOV.AU AND REF GG APIS",
							"     SEE RTSVC",
							"  2  QF 675 Q 10FEB 1*MELADL DK2   835A 925A 10FEB  E  0 73H B",
							"     SEE RTSVC",
							"  3  QF2142 Q 10FEB 1*ADLKGC DK2  1050A1125A 10FEB  E  0 DH3 R",
							"     OPERATED BY QANTASLINK - EASTERN AUSTRALIA A/L",
							"     OPERATED BY SUBSIDIARY/FRANCHISE",
							"     SEE RTSVC",
							"  4  QF1016 Y 24FEB 1*HBAMEL DK2   550P 710P 24FEB  E  0 73H R",
							"     SEE RTSVC",
							"  5  QF 049 Y 24FEB 1*MELSFO DK2  1035P 545P 24FEB  E  0 789 RM",
							"     MANDATORY NAME GENDER DOB REQMTS REFR US SECURE",
							"     FLIGHT PLUS MANDATORY US VISA REQMTS REFR ESTA",
							"     VISIT QANTAS.COM FOR ELIGIBILITY AND INSTRUCTION",
							"     ADV PAX WWW.SMARTRAVELLER.GOV.AU AND REF GG APIS",
					...
					},
					{
						"cmd": "SBI4,5",
						"output": [
							"/$  QF1016 I 24FEB 1 HBAMEL REBOOK REJECTED: SEGMENT NOT AVAILABLE",
							"  QF 049 I 24FEB 1 MELSFO REBOOK REJECTED: SEGMENT NOT AVAILABLE",
							"AD24FEBHBASFO1750",
							"** AMADEUS AVAILABILITY - AD ** SFO SAN FRANCISCO.USCA       187 MO 24FEB  550P",
							" 1   QF1016  J8 C8 D5 IL Y9 B9 H9 /HBA D MEL 1  550P    710P  E0/73H",
							"             K9 M9 L9 V9 S9 N9 Q9 O9 X9 E9",
							"     QF 049  J8 C8 D5 IL W9 R9 TL /MEL 2 SFO I 1035P    545P  E0/789      18:55",
							"             Y9 B9 H9 K9 M9 L9 V9 S9 N9 Q9 O9 X9 E9",
							"             SUBJECT TO GOVERNMENT APPROVAL",
							" 2   QF1016  J8 C8 D8 I8 Y9 B9 H9 /HBA D MEL 1  550P    710P  E0/73H",
							"             K9 M9 L9 V9 S9 N9 Q9 O9 X9 E9",
							"  QF:AS5009  F0 P0 I0 Y7 S7 B7 M7 /MEL 2 SFO I 1035P    545P  E0/789      18:55",
							"             H7 Q7 L7 V7 K7 G7 T7 R7",
							"             SUBJECT TO GOVERNMENT APPROVAL",
							" 3   QF1016  J8 C8 D8 I8 Y9 B9 H9 /HBA D MEL 1  550P    710P  E0/73H",
							"             K9 M9 L9 V9 S9 N9 Q9 O9 X9 E9",
							"  QF:AA7376  J7 R7 D0 I0 W7 P0 Y7 /MEL 2 SFO I 1035P    545P  E0.789      18:55",
			...
			sessionInfo: {
				...
				performedCommands: [
					{
						"cmd": "SSQF50Y08FEBSFOMEL2",
						"output": [
							"/$--- SFP ---",
							"RP/SFO1S2195/",
							"  1  QF 050 Y 08FEB 6 SFOMEL DK2   815P 645A 10FEB  E  0 789 DR",
							"     MANDATORY NAME GENDER DOB REQMTS REFR US SECURE",
							"     FLIGHT PLUS MANDATORY US VISA REQMTS REFR ESTA",
							"     VISIT QANTAS.COM FOR ELIGIBILITY AND INSTRUCTION",
							"     ADV PAX WWW.SMARTRAVELLER.GOV.AU AND REF GG APIS",
					...
					},
					{
						...
						"output": [
							...
							"     ADV PAX WWW.SMARTRAVELLER.GOV.AU AND REF GG APIS",
							"     SEE RTSVC",
							"  2  QF 675 Y 10FEB 1*MELADL DK2   835A 925A 10FEB  E  0 73H B",
							"     SEE RTSVC",
							"  3 RM NOTIFY PASSENGER PRIOR TO TICKET PURCHASE & CHECK-IN:",
							"       FEDERAL LAWS FORBID THE CARRIAGE OF HAZARDOUS MATERIALS -",
							"       GGAMAUSHAZ/S1",
					...
					},
					{
						...
						"output": [
							...
							"  2  QF 675 Y 10FEB 1*MELADL DK2   835A 925A 10FEB  E  0 73H B",
							"     SEE RTSVC",
							"  3  QF2142 Y 10FEB 1*ADLKGC DK2  1050A1125A 10FEB  E  0 DH3 R",
							"     OPERATED BY QANTASLINK - EASTERN AUSTRALIA A/L",
							"     OPERATED BY SUBSIDIARY/FRANCHISE",
							"     SEE RTSVC",
							"  4 RM NOTIFY PASSENGER PRIOR TO TICKET PURCHASE & CHECK-IN:",
					...
					},
					{
						"cmd": "MDR",
						"output": [
							"/$  6  AC 561 Y 25FEB 2 SFOYVR DK2   620A 848A 25FEB  E  0 319 F",
							"     Y CABIN/PAY FOR MEALS/REPAS A LA CARTE A VOS FRAIS",
							"     PET RESTRICTIONS D ANIMAUX AIRBUS CRJ EMB BEH CIC 70/13",
	...
	async testPccChange({input, output, sessionInfo, stubs}) {
		...
		let actualOutput = await RunCmdRq({
			stateful, cmdRq: input.cmdRequested, gdsClients: {amadeus},
