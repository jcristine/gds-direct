        ...
        $list.push([
            ...
            ]),
            {
                'parsedData': {
                    ...
                    'itinerary': [
                        {'segmentNumber': 1,'airline': 'EK','flightNumber': '134','bookingClass': 'Q','departureAirport': 'DME','destinationAirport': 'DXB','segmentStatus': 'SS','statusNumber': '1','confirmationAirline': 'EK'},
                        {'segmentNumber': 2,'airline': 'EK','flightNumber': '312','bookingClass': 'Q','departureAirport': 'DXB','destinationAirport': 'HND','segmentStatus': 'SS','statusNumber': '1','confirmationAirline': 'EK'},
                        {'segmentNumber': 3,'airline': 'EK','flightNumber': '313','bookingClass': 'Q','departureAirport': 'HND','destinationAirport': 'DXB','segmentStatus': 'SS','statusNumber': '1','confirmationAirline': 'EK'},
                        {'segmentNumber': 4,'airline': 'EK','flightNumber': '133','bookingClass': 'Q','departureAirport': 'DXB','destinationAirport': 'DME','segmentStatus': 'SS','statusNumber': '1','confirmationAirline': 'EK'},
                    ],
