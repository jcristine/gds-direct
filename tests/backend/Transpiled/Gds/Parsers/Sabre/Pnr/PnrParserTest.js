...
class PnrParserTest extends require('../../../../Lib/TestCase.js') {
	providePartialTestDumpList() {
			...
			]),
			{
				'parsedData': {
					...
					'phones': [{
						'lineNumber': 1,
						'raw': 'MOW4997031471',
						'parsed': {'city': 'MOW', 'phoneNumber': '4997031471'}
					}],
					'pnrInfo': {
						'receivedFrom': 'JACOB',
						'time': {'parsed': '08:36'},
				...
				'parsedData': {
					...
					'tktgData': {
						'ticketingInfo': {
							'type': 'timeLimit',
							'pcc': 'O4HG',
							'tauDate': {'raw': '13JUL', 'parsed': '07-13'},
							'tauTime': {'raw': '0400A', 'parsed': '04:00'}
						}, 'tickets': []
					},
					'phones': [{
						'lineNumber': 1,
						'raw': 'MOW4997030516',
						'parsed': {'city': 'MOW', 'phoneNumber': '4997030516', 'phoneTypeToken': null}
					}],
					'aaFacts': [{
						'lineNumber': 1,
						'ssrCode': 'OTHS',
						'airline': 'AA',
						'data': {'comment': ' RITL/ PLS ADV TKT NOS BY 14JUL14 09 19 MOW LT'}
					}],
					'remarks': [],
					'pnrInfo': {
						'receivedFrom': 'ALINA',
						...
						'homePcc': '6IIF',
						'agentInitials': '55',
						'time': {'raw': '0619', 'parsed': '06:19'},
						'date': {'raw': '05JUL14', 'parsed': '2014-07-05'},
						'recordLocator': 'UGWABO'
					},
				},
			}
		]);
				...
				'parsedData': {
					...
					'aaFacts': {
						'1': {
							'ssrCode': 'ADTK',
							'airline': '1S',
							'data': {'comment': 'KK4.TKT UASEGS BY 19JUL16 TO AVOID AUTO CXL /EARLIER'}
						},
					},
					'tktgData': {
						'ticketingInfo': {
							'type': 'ticketed',
							'ticketingDate': {'parsed': '07-16'},
							'pcc': '6IIF',
							'agentInitials': 'TS'
						}
					},
					...
					'passengers': {
						'parsedData': {
							'passengerList': [
								...
								{
									'nameNumber': {'raw': '3.1'},
									'firstName': 'SOPHIA ANGELIKA',
									'lastName': 'HYSA',
									'age': null
								},
								{
									'nameNumber': {'raw': '4.I/1'},
									'firstName': 'ALEXANDER PETRO',
									'lastName': 'HYSA',
									'dob': {'parsed': '2015-05-04'}
								},
							],
						},
					},
					...
					'passengers': {
						'parsedData': {
							'passengerList': [
								...
								{
									'nameNumber': {'raw': '2.1'},
									'firstName': 'WAMBUI FAUZIA',
									'lastName': 'WAWERU',
									'age': 11
								},
								{
									'nameNumber': {'raw': '3.1'},
									'firstName': 'WANGARI MARIA',
									'lastName': 'WAWERU',
									'age': 9
								},
								{
			...
			]),
			{
				'parsedData': {
					'remarks': {
						'14': {
							'lineNumber': '15',
							'data': 'H-ASC-NEW EARLIER SCHD VIOLATES DEFINED TIME TOLERANCE 29OCT/0832'
						},
						'19': {
							'lineNumber': '20',
							'data': 'V¥EM-SCHEDULE ATTACHED AND CONTACT YOUR TRAVEL AGENT WITHIN 2 DAYS'
						},
					},
				},
			}
		...
		// with tickets in *R, caused error - https://diag.dyninno.net/events/4335831826
		$list.push([
			php.implode(php.PHP_EOL, [
			    'ZLHMNX',
			    ' 1.1BENTIL/JUVENTIUS ERNESTEKOW',
			    ' 1 ET 509Q 12APR F EWRLFW HK1   915P 1135A  13APR J',
			    '                                               /DCET*ZLHNJA /E',
			    ' 2 KP  20L 13APR J LFWACC HK1  1240P  120P /DCKP*NYS7V /E',
			    ' 3 KP  23L 29APR M ACCLFW HK1  1050A 1140A /DCKP*NYS7V /E',
			    ' 4 KP  21L 30APR T ACCLFW HK1  1050A 1140A *',
			    ' 5 ET 508L 30APR T LFWEWR HX1  1200N  715P /DCET*ZLHNJA /E',
			    ' 6 ET 508V 30APR T LFWEWR HX1  1200N  715P /DCET*ZLHNJA /E',
			    ' 7 ET 508U 30APR T LFWEWR HK1  1200N  715P /DCET*ZLHNJA /E',
			    ' 8 ET 508U 30APR T LFWEWR UN1  1215P  715P /DCET*ZLHNJA /E',
			    ' 9  OTH YY 27OCT S GK1  XXX/PRESERVEPNR',
			    'TKT/TIME LIMIT',
			    '  1.T-25MAR-6IIF*AWS',
			    '  2.TE 0712123419219 BENTI/J SYSSYS 0556/08APR',
			    'PHONES',
			    '  1.SFO800-750-2238-A',
			    '  2.P EWR2145794367 C',
			    'INVOICED ',
			    ...
			    'SECURITY INFO EXISTS *P3D OR *P4D TO DISPLAY',
			    'AA FACTS',
			    '  1.SSR OTHS 1S AUTO XX IF SSR TKNA/E/M/C NOT RCVD BY KP BY 184',
			    '    4/30MAR/LFW LT',
			    '  2.SSR OTHS 1S PLS ADTK BY 31MAR19 1844 GMT OR SEATS WILL BE X',
			    '    LD',
			    '  3.SSR OTHS 1S PLS PROVIDE REQUIRED DOCS INFORMATION',
			    '  5.SSR OTHS 1S HX CANCELED DUE TO SYSTEM OR PASSENGER ACTION',
			    '  6.SSR OTHS 1S HX DELETE HX SEGS FROM PNR TO KEEP RES IN SYNCH',
			    '  8.SSR OTHS 1S PLZ UPDATE ITIN BY XXL ALL HX SEGMENTS',
			    '  9.SSR OTHS 1S PLS ADTK TO PREVENT IMMEDIATE CXL',
			    ' 10.SSR OTHS 1S MCT VIOLATION DETECTED BTWN SEG ACC-LFW AND LFW',
			    '    -EWR',
			    ' 11.SSR OTHS 1S HX CANCELED DUE TO SYSTEM OR PASSENGER ACTION',
			    ' 12.SSR OTHS 1S HX DELETE HX SEGS FROM PNR TO KEEP RES IN SYNCH',
			    ' 13.SSR OTHS 1S XXLD DUE TO TTL EXPIRED',
			    ' 14.SSR OTHS 1S PLZ UPDATE ITIN BY XXL ALL HX SEGMENTS',
			    ' 15.SSR OTHS 1S HX CANCELED DUE TO SYSTEM OR PASSENGER ACTION',
			    ' 16.SSR OTHS 1S HX DELETE HX SEGS FROM PNR TO KEEP RES IN SYNCH',
			    ' 20.SSR OTHS 1S INVALID MINIMUM CONNECTION TIME',
			    ' 21.SSR OTHS 1SAUTOXX IF SSR TKNA/E/M/C NOT RCVD BY KP BY 1054/',
			    '    09A PR/',
			    ' 22.SSR OTHS 1S ///LFW LT',
			    ' 23.SSR OTHS 1S MCT VIOLATION DETECTED BTWN SEG ACC-LFW AND LFW',
			    '    -EWR',
			    ' 24.SSR OTHS 1S.REMOVE DUPE SEGS BY 12APR 0249 LT LFW OR CANX',
			    'GENERAL FACTS',
			    '  1.SSR CTCE ET HK1/JUVENTIUSB//GMAIL.COM',
			    '  2.SSR CTCE KP HK1/JUVENTIUSB//GMAIL.COM',
			    '  8.SSR CTCM ET HK1/12145794367',
			    '  9.SSR CTCM KP HK1/12145794367',
			    'REMARKS',
			    '  1.GD-ELMAN/6064/FOR HART/21270/LEAD-11066088 IN 6IIF',
			    '  2.-*CAXXXXXXXXXXXX7740¥XXXXX',
			    '  3.H-AUTH-MSTR/IK7740/25MAR/01811553549100813428       ',
			    '  4.H-  AUTH-APV/061243/00/USD1099.95                   ',
			    '  5.H-  AUTH-CSC NOT SUPPLIED/                          ',
			    '  6.H-  AUTH-AVS NOT SUPPORTED/                         ',
			    '  7.H-XXAUTH/061243/CAXXXXXXXXXXXX7740/ET/USD1099.95/25MAR/S',
			    '  8.XXTAW/25MAR',
			    '  9.OSIKPCTCPPEWR2145794367C',
			    'ACCOUNTING DATA',
			    '  1.  ET¥7338351872/  39.82/     423.00/ 676.95/ONE/CCCAXXXXXXX',
			    '      XXXXX7740 1.1BENTIL JUVENTIUS ERNESTEKOW/1/F/E',
			    'RECEIVED FROM - ELMAN',
			    '6IIF.L3II*AWS 1344/25MAR19 ZLHMNX H',
			]),
			{
				parsedData: {
					pnrInfo: {
						recordLocator: 'ZLHMNX',
					},
					tktgData: {
						ticketingInfo: {
							type: 'ticketed',
		...
		// failed on remark parser because tried to parse "TKT INSTRUCTIONS" section as remarks
		// session #107310
		$list.push([
			php.implode(php.PHP_EOL, [
				"POKIWI",
			...
			]),
			{
				parsedData: {
					"remarks": [
						{"lineNumber":"1","remarkType":"UNKNOWN","data":"/ITN","line":"  1./ITN"},
						{"lineNumber":"2","remarkType":"UNKNOWN","data":"/100 PINE STREET SUITE 1925","line":"  2./100 PINE STREET SUITE 1925"},
						{"lineNumber":"3","remarkType":"UNKNOWN","data":"/SAN FRANCISCO CA 94111","line":"  3./SAN FRANCISCO CA 94111"},
						{"lineNumber":"4","remarkType":"UNKNOWN","data":"/800-750-2041-INTERNATIONAL TRAVEL NETWORK","line":"  4./800-750-2041-INTERNATIONAL TRAVEL NETWORK"},
						{"lineNumber":5,"remarkType":"FOP_REMARK","data":{"type":"cash"},"line":"  5.-CHECK"},
						{"lineNumber":"6","remarkType":"UNKNOWN","data":"H-PICCCADT-777.43","line":"  6.H-PICCCADT-777.43"},
						{"lineNumber":"7","remarkType":"UNKNOWN","data":"H-PICCCCHD-728.43","line":"  7.H-PICCCCHD-728.43"},
						{"lineNumber":"8","remarkType":"UNKNOWN","data":"START ST PROCESS - 24APR2019 17.38.03","line":"  8.START ST PROCESS - 24APR2019 17.38.03"},
						{"lineNumber":"9","remarkType":"UNKNOWN","data":".S*UD1 N","line":"  9..S*UD1 N"},
						{"lineNumber":"10","remarkType":"UNKNOWN","data":"RETENTION CHANGED","line":" 10.RETENTION CHANGED"},
						{"lineNumber":"11","remarkType":"UNKNOWN","data":"TICKETING STARTED","line":" 11.TICKETING STARTED"},
						{"lineNumber":"12","remarkType":"UNKNOWN","data":"H-WARNING WITH STAR","line":" 12.H-WARNING WITH STAR"},
						{"lineNumber":"13","remarkType":"UNKNOWN","data":"XXTAWDK8H24APR009/","line":" 13.XXTAWDK8H24APR009/"},
						{"lineNumber":"14","remarkType":"UNKNOWN","data":"H-TICKETED AND INVOICED FOR  PAX.","line":" 14.H-TICKETED AND INVOICED FOR  PAX."},
						{"lineNumber":"15","remarkType":"UNKNOWN","data":".S*UD8 10","line":" 15..S*UD8 10"},
						{"lineNumber":"16","remarkType":"UNKNOWN","data":".S*FV738.43*10.00","line":" 16..S*FV738.43*10.00"},
						{"lineNumber":"17","remarkType":"UNKNOWN","data":"H-WARNING WITH STAR","line":" 17.H-WARNING WITH STAR"},
						{"lineNumber":"18","remarkType":"UNKNOWN","data":"H-TICKETED AND INVOICED FOR  PAX.","line":" 18.H-TICKETED AND INVOICED FOR  PAX."},
						{"lineNumber":"19","remarkType":"UNKNOWN","data":"FINISH TICKETING PROCESS.","line":" 19.FINISH TICKETING PROCESS."}
					],
					"tktInstructions": [
						{
							"lineNumber": "1",
							"pricingModifiers": [
								{"raw":"W","type":null,"parsed":null},
								{"raw":"PQ1","type":null,"parsed":null},
								{"raw":"AUA","type":"validatingCarrier","parsed":"UA"},
								{"raw":"K0.00","type":"commission","parsed":{"units":"amount","region":null,"value":"0.00"}}
							]
						},
						{
							"lineNumber": "2",
