    ...
    provideTestCases()  {
        ...
        $list.push([
            ...
            ]),
            {
                ...
                'ssrSegments': [
                    {
                        ...
                        'passengers': [
                            ...
                            {'passengerNumber': '2', 'ssrs': [{'ssrCode': 'INFT'}, {'ssrCode': 'LANG'}, {'ssrCode': 'VGML'}]},
                ...
                'otherSsrs': [
                    ...
                    {'lineNumber': '2', 'ssrCode': 'CHLD', 'airline': 'DL', 'status': 'HK', 'statusNumber': '1', 'content': '/'},
                    {'lineNumber': '3', 'ssrCode': 'CHLD', 'airline': 'DL', 'status': 'NO', 'statusNumber': '1', 'content': '/'},
                ],
                'mileageProgramData': {
                    'passengers': [
                        {
        ...
        $list.push([
            ...
            ]),
            {
                ...
                'vlocData': [
                    {'lineNumber': '1', 'airline': 'UA', 'recordLocator': 'PLDDF9', 'date': {'raw': '08MAR'}, 'time': {'raw': '1352'}},
                    {'lineNumber': '2', 'airline': '1A', 'recordLocator': 'SV2AMX', 'date': {'raw': '08MAR'}, 'time': {'raw': '1352'}},
                ],
                'vendorSsrs': [
        ...
        $list.push([
            ...
            {
                'itineraryData': [
                    {'segmentNumber': 1, 'segmentType': 'FAKE', 'segmentStatus': 'BK', 'statusNumber': 1, 'daysOfWeek': {'raw': 'WE'}},
        ...
        $list.push([
            ...
            {
                'vlocData': [
                    {'lineNumber': '1', 'airline': 'DL', 'recordLocator': 'JORYVY', 'date': {'raw': '12JUL'}, 'time': {'raw': '1437'}},
                ],
            },
        ]);
        ...
        $list.push([
            ...
            ]),
            {
                ...
                'otherSsrs': [
                    {'lineNumber': '1', 'ssrCode': 'ADPI', 'content': 'MF0857 REQ SEC FLT PSGR DATA 72 HBD FOR ALL PSGRS'},
                ],
                'seatDataSegments': [],
                'vendorSsrs': [
