...
class PricingParserTest extends require('../../../../../../backend/Transpiled/Lib/TestCase.js')
{
	provideDumps()  {
		...
		// 'ROUND THE WORLD FARES QUOTED-AGENT MUST VERIFY RULES'
		$list.push([
			[
				">$BBA/*JWZ/S1-*2G52|2-*2G52|3-*2G52|4-*2G52|5-*2G52//@C",
				"                **NO FARE GUARANTEE**",
				"ROUND THE WORLD FARES QUOTED-AGENT MUST VERIFY RULES",
				"",
				"*FARE HAS A PLATING CARRIER RESTRICTION*",
				"E-TKT REQUIRED",
				"BOOK PNR SEGMENTS     1I/2I/3I/4I/5I",
				"",
				"*PENALTY APPLIES*",
				"BEST FARE FOR PSGR TYPE",
				"TICKETING WITHIN 72 HOURS AFTER RESERVATION",
				"LAST DATE TO PURCHASE TICKET: 01SEP19 / 0932 SFO",
				"$BBA-1 C29AUG19     ",
				"SEA DL X/SEL DL HKG KL X/AMS KL FRA DL DTT 9860.00IRTWSKY3 Q",
				"SEADTT580.00NUC10440.00END ROE1.0",
				"FARE USD 10440.00 TAX 5.60AY TAX 37.20US TAX 3.96XA TAX 4.50XF",
				"TAX 7.00XY TAX 5.77YC TAX 8.30BP TAX 22.90G3 TAX 15.30HK TAX",
				"6.40I5 TAX 7.20CJ TAX 7.10RN TAX 10.50DE TAX 46.10OY TAX",
				"37.30RA TOT USD 10665.13   ",
				"S5 NVB22SEP",
				"E VLD SKYTEAM ONLY/NONREF",
				"TICKETING AGENCY 2G52",
				"DEFAULT PLATING CARRIER DL",
				"US PFC: XF SEA4.5 ",
				"BAGGAGE ALLOWANCE",
				...
				" KE SEASEL  2PC                                             ",
				"   BAG 1 -  NO FEE       CARRYON HAND BAGGAGE ALLOWANCE   ",
				"   BAG 2 -  NO FEE       UPTO40LB/18KG AND UPTO45LI/115LCM",
				" KE SELHKG  2PC                                             ",
				"   BAG 1 -  NO FEE       CARRYON HAND BAGGAGE ALLOWANCE   ",
				"   BAG 2 -  NO FEE       UPTO40LB/18KG AND UPTO45LI/115LCM",
				" KL HKGAMS  2PC                                             ",
				...
				"   BAG 1 -  NO FEE       PERSONAL ITEM                    ",
				"                                                                EMBARGO - FOR BAGGAGE LIMITATIONS SEE ",
				" DL FRADTT  VIEWTRIP.TRAVELPORT.COM/BAGGAGEPOLICY/DL        ",
				"                                                                BAGGAGE DISCOUNTS MAY APPLY BASED ON FREQUENT FLYER STATUS/",
				"ONLINE CHECKIN/FORM OF PAYMENT/MILITARY/ETC.",
			].join('\n'),
			{
		...
		// INFORMATION ONLY - BOOKING DATE MODIFIED
		// $B/N1*ADT|2*C07|3*C07/T
		// possibly caused by the /T/ added as typo I think
		$list.push([
			[
				">$B/N1*ADT|2*C07|3*C07/-*2G2H/T",
				"*FARE HAS A PLATING CARRIER RESTRICTION*",
				"E-TKT REQUIRED",
				"INFORMATION ONLY - BOOKING DATE MODIFIED",
				"",
				"** PRIVATE FARES SELECTED **  ",
				"*PENALTY APPLIES*",
				"LAST DATE TO PURCHASE TICKET: 01OCT19 SFO",
				"$B-1 A10SEP19     ",
				"SFO UA SIN 2047.95PFXT2NMF/PY10 UA SFO 2272.95PFWT2NMF/PY10",
				"NUC4320.90END ROE1.0",
				"FARE USD 4321.00 TAX 5.60AY TAX 37.20US TAX 3.96XA TAX 4.50XF",
				"TAX 7.00XY TAX 5.77YC TAX 7.80L7 TAX 4.40OP TAX 25.60SG TOT USD",
				"4422.83  ",
				"S1 NVB16APR/NVA16APR",
				"S2 NVB03MAY/NVA03MAY",
				...
				"LAST DATE TO PURCHASE TICKET: 01OCT19 SFO",
				"$B-2-3 A10SEP19     ",
				"SFO UA SIN 2047.95PFXT2NMF/CH UA SFO 2272.95PFWT2NMF/CH",
				"NUC4320.90END ROE1.0",
				"FARE USD 4321.00 TAX 5.60AY TAX 37.20US TAX 3.96XA TAX 4.50XF",
				"TAX 7.00XY TAX 5.77YC TAX 7.80L7 TAX 4.40OP TAX 25.60SG TOT USD",
				"4422.83  ",
