    ...
    provideTreeTestCases()  {
        ...
        $list.push([
            ...
            ]),
            {
                ...
                'passengers': {'passengerList': [{'nameNumber': {'raw': '1.1'},'firstName': 'LORA CINDY','lastName': 'LEHMAN'}]},
                'itineraryData': [
                    {'segmentNumber': 1,'airline': 'CZ','segmentStatus': 'HK','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                    {'segmentNumber': 2,'airline': 'CZ','segmentStatus': 'HK','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                    {'segmentNumber': 3,'airline': 'CZ','segmentStatus': 'UN','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                    {'segmentNumber': 4,'airline': 'CZ','segmentStatus': 'UN','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                    {'segmentNumber': 5,'airline': 'CZ','segmentStatus': 'WK','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                    {'segmentNumber': 6,'airline': 'CZ','segmentStatus': 'TK','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                    {'segmentNumber': 7,'airline': 'CZ','segmentStatus': 'HK','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                ],
                ...
                'remarks': [
                    {
                        ...
                        'data': {'passengerNumber': 1,'sellingPrice': '1248.96','netPrice': '1178.96','fare': '417.00'},
                    },
                ],
            }
        ]);
        $list.push([
            ...
            ]),
            {
                ...
                'passengers': {'passengerList': [{'nameNumber': {'raw': '1.1'},'firstName': 'JOSEPH NANA','lastName': 'TORMEN'}]},
                'itineraryData': {
                    '0': {'segmentNumber': 1,'airline': 'UA','segmentStatus': 'HK','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                    '3': {'segmentNumber': 4,'airline': 'UA','segmentStatus': 'HK','segmentType': 'SEGMENT_TYPE_ITINERARY_SEGMENT'},
                },
        ...
        $list.push([
            ...
            ]),
            {
                ...
                'passengers': {'passengerList': [{'nameNumber': {'raw': '1.1'},'firstName': 'CHARLES','lastName': 'HARRIS'}]},
            }
        ]);
        $list.push([
            php.implode(php.PHP_EOL, [
        ...
        $list.push([
            ...
            ]),
            {
                ...
                'itineraryData': [{'destinationAirport': 'DFW','statusNumber': 29},{'destinationAirport': 'PIT','statusNumber': 29}],
                'atfqData': [
                    {
                        'lineNumber': '1',
                    ...
                    {'lineNumber': '3','isManualPricingRecord': true},
                    {
                        'lineNumber': '4',
                        'isManualPricingRecord': true,
                        'pricingModifiers': [{'parsed': {'passengerProperties': {'0': {'passengerNumber': 26},'4': {'passengerNumber': 30}}}}],
                    },
                ],
            }
        ]);
        $list.push([
            ...
            ]),
            {
                'passengers': {
                    'passengerList': [
                        {'lastName': 'LARIOZA','firstName': 'FLORIAN','nameNumber': {'fieldNumber': '1','firstNameNumber': 1}},
                        {'lastName': 'LARIOZA','firstName': 'EXST','nameNumber': {'fieldNumber': '1','firstNameNumber': 2}},
                        {'lastName': 'CERCADO','firstName': 'DAVID CASTOR','nameNumber': {'fieldNumber': '2','firstNameNumber': 1}},
                    ],
                },
                'atfqData': [
                    {'pricingModifiers': [{'parsed': {'passengerProperties': [{'passengerNumber': 1,'firstNameNumber': 1}]}}]},
                    {'pricingModifiers': [{'parsed': {'passengerProperties': [{'passengerNumber': 1,'firstNameNumber': 2}]}}]},
                ],
            }
        ]);
        $list.push([
        ...
        $list.push([
            ...
            ]),
            {
                'atfqData': [
                    {
                        'pricingModifiers': {
                            '0': {'type': 'passengers','parsed': {'passengerProperties': [{'ptc': 'JCB','markup': '23'}]}},
        ...
        $list.push([
            ...
            ]),
            {
                'atfqData': [
                    ...
                    {'pricingModifiers': [{'type': 'passengers','parsed': {'passengerProperties': [{'passengerNumber': 6}]}}]},
                ],
