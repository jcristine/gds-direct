...
class SsrBlockParserTest extends require('../../../../Lib/TestCase.js')
{
	provideTreeTestDumpList()  {
		...
		$list.push([
			...
			{
				'5': {'ssrCode': 'DOCS','airline': 'DL','data': {'dob': {'parsed': '1945-10-01'}}},
			}
		]);
		...
		$list.push([
			...
			[
				{'lineNumber': 1,'airline': 'DL','ssrCode': 'DOCS','content': '/////13MAY79/M//KUHNELL/MICHAEL/ANDREW',
					'data': {
						...
						'firstName': 'MICHAEL',
						'middleName': 'ANDREW',
						'paxName': 'KUHNELL/MICHAEL ANDREW',
					},
				},
				{'lineNumber': 2,'airline': 'DL','ssrCode': 'DOCS','content': '/////01JAN13/F//KUHNELL/MERET/ELISABETH',
					'data': {
						...
						'paxName': 'KUHNELL/MERET ELISABETH',
					},
				},
		...
		$list.push([
			...
			[
				{'lineNumber': 1,'airline': '1V','ssrCode': 'ADTK','content': 'BY 16SEP 1638 PHX TIME ZONE OTHERWISE WILL BE XLD'},
				...
				{'lineNumber': 5,'airline': 'CI','ssrCode': 'DOCS','content': '/////20JUN70/M//VILLANUEVAJR/SENEN/LAGMAY'},
				{'lineNumber': 6,'airline': 'CI','ssrCode': 'DOCS','content': '/////03JUL63/F//PASCUAL/AMELIA/VILLANUEVA'},
	...
	testParser($ssrBlockDump, $expected)  {
		...
		$actual = SsrBlockParser.parse($ssrBlockDump);
