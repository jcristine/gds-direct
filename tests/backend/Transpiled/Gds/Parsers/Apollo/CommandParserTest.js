...
class CommandParserTest extends require('../../../../../../backend/Transpiled/Lib/TestCase.js')
{
    provideTestDumpList()  {
        ...
        $list.push(['$B-NYC09', {'type': 'priceItinerary', 'data': {
            'pricingModifiers': [
        ...
        $list.push(['$B\/-NYC09*2CV4', {'type': 'priceItinerary', 'data': {
            'pricingModifiers': [
        ...
        $list.push(['$BS1@Y1N0C9M0-NYC09*2CV4|2-NYC09@Y1N0C9M0', {'type': 'priceItinerary', 'data': {
            'pricingModifiers': [
                {'raw': 'S1@Y1N0C9M0-NYC09*2CV4|2-NYC09@Y1N0C9M0', 'type': 'segments', 'parsed': {
                    'bundles': [
                        {'segmentNumbers': ['1'], 'fareBasis': 'Y1N0C9M0', 'accountCode': 'NYC09', 'pcc': '2CV4'},
        ...
        $list.push(['MP*UA12345678910', {'type': 'addFrequentFlyerNumber', 'data': {
            'passengers': [{
        ...
        $list.push(['MPN1*\u00A4LH12345678910', {'type': 'addFrequentFlyerNumber', 'data': {
            'passengers': [{
        ...
        $list.push(['MPN1-1*@AA8853315554*@BA9742123848*@DL3158746568|N2-1*@AA4346366363*@BA2315488786*@DL7845453554', {'type': 'addFrequentFlyerNumber', 'data': {
            'passengers': [
                {
        ...
        $list.push(['MP\/X\/N1*DL|2*AA', {'type': 'changeFrequentFlyerNumber', 'data': {
            'passengers': [
                {
                    'majorPaxNum': '1', 'minorPaxNum': '',
        ...
        $list.push(['$D19DECFSMMNL|DL'         , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '19DEC'}, 'departureAirport': 'FSM', 'destinationAirport': 'MNL'}}]);
        $list.push(['$D16NOVSLCTYO|UA'         , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '16NOV'}, 'departureAirport': 'SLC', 'destinationAirport': 'TYO'}}]);
        $list.push(['$D20DECYVRGYE|AC'         , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '20DEC'}, 'departureAirport': 'YVR', 'destinationAirport': 'GYE'}}]);
        $list.push(['$D10SEPNYCCNF|AA-JCB-Q:L' , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '10SEP'}, 'departureAirport': 'NYC', 'destinationAirport': 'CNF'}}]);
        $list.push(['$DV6DECNYCLOS17DEC'       , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '6DEC'}, 'departureAirport': 'NYC', 'destinationAirport': 'LOS'}}]);
        $list.push(['$DV5SEPDTTNSI14JAN'       , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '5SEP'}, 'departureAirport': 'DTT', 'destinationAirport': 'NSI'}}]);
        $list.push(['$DV23OCTRDUMNL27NOV'      , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '23OCT'}, 'departureAirport': 'RDU', 'destinationAirport': 'MNL'}}]);
        $list.push(['$DV15SEPLAXLOS:OW'        , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '15SEP'}, 'departureAirport': 'LAX', 'destinationAirport': 'LOS'}}]);
        $list.push(['$DV18DECPDXLON28DEC'      , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '18DEC'}, 'departureAirport': 'PDX', 'destinationAirport': 'LON'}}]);
        $list.push(['$DV12SEPYYZMNL10OCT|AC'   , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '12SEP'}, 'departureAirport': 'YYZ', 'destinationAirport': 'MNL'}}]);
        $list.push(['$DV14AUGBOSLON24AUG'      , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '14AUG'}, 'departureAirport': 'BOS', 'destinationAirport': 'LON'}}]);
        $list.push(['$DV20NOVWASJNB1DEC\/\/@C'   , {'type': 'fareSearch', 'data': {
        ...
        $list.push(['$DV12NOVLAXMNL3DEC|CX'    , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '12NOV'}, 'departureAirport': 'LAX', 'destinationAirport': 'MNL'}}]);
        $list.push(['$DV19AUGSEADKR15OCT|UA'   , {'type': 'fareSearch', 'data': {'departureDate': {'raw': '19AUG'}, 'departureAirport': 'SEA', 'destinationAirport': 'DKR'}}]);
        $list.push(['$DNYCMNL28NOV17T12MAR17:RT+DL-M', {'type': 'fareSearch', 'data': {
        ...
        $list.push(['$D30SEPORLRUH\u00A4C+AF'   , {'type': 'fareSearch', 'data': {
