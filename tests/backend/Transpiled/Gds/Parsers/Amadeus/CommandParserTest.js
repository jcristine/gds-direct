...
class CommandParserTest extends require('../../../Lib/TestCase.js')
{
    provideCommands()  {
        ...
        $list.push(['FFNUA-123456778910,UA,LH\/P1', {'type': 'addFrequentFlyerNumber', 'data': {
            'airline': 'UA', 'code': '123456778910',
            'partners': ['UA','LH'], 'majorPaxNum': '1',
        }}]);
        $list.push(['DOLH123\/29APR', {'type': 'flightServiceInfo'}]);

        $list.push(['XE19-22', {'type': 'deletePnrField', 'data': {
            'lineNumbers': [
                {'major': '19'},
                {'major': '20'},
                {'major': '21'},
        ...
        $list.push(['XE3', {'type': 'deletePnrField', 'data': {
            'lineNumbers': [
                {'major': '3'},
            ],
        }}]);
        $list.push(['XE1,2,5', {'type': 'deletePnrField', 'data': {
            'lineNumbers': [
                {'major': '1'},
                {'major': '2'},
                {'major': '5'},
        ...
        $list.push(['XE4.1', {'type': 'deletePnrField', 'data': {
            'lineNumbers': [
                {'major': '4', 'minor': '1'},
            ],
        }}]);
        // delete group name
        $list.push(['XE0.1', {'type': 'deletePnrField', 'data': {
            'lineNumbers': [
                {'major': '0', 'minor': '1'},
            ],
        }}]);
        // TO CANCEL MULTIPLE ELEMENTS, ENTER, FOR EXAMPLE
        $list.push(['XE3,4,6-8', {'type': 'deletePnrField', 'data': {
            'lineNumbers': [
                {'major': '3'},
                {'major': '4'},
                {'major': '6'},
        ...
        $list.push(['XE7.1,7.3', {'type': 'deletePnrField', 'data': {
            'lineNumbers': [
                {'major': '7', 'minor': '1'},
                {'major': '7', 'minor': '3'},
            ],
        ...
        $list.push(['8\/ASDDASD', {'type': 'changePnrField', 'data': {
            'majorNum': '8',
            'content': 'ASDDASD',
        }}]);
        // changes MCO commission line
        $list.push(['7.3\/0', {'type': 'changePnrField', 'data': {
            'majorNum': '7',
            'minorNum': '3',
            'content': '0',
        }}]);

        $list.push(['FQDMNLSFO\/R,25APR18,P\/29JUN18\/AKE\/CQ'    , {'type': 'fareSearch', 'data': {'departureAirport': 'MNL', 'destinationAirport': 'SFO', 'modifiers': [{'raw': 'R,25APR18,P'}, {'type': 'travelDates', 'raw': '29JUN18'}]}}]);
        $list.push(['FQDMNLSFO\/R,25APR18,P\/29JUN18\/AKE\/CU'    , {'type': 'fareSearch', 'data': {'departureAirport': 'MNL', 'destinationAirport': 'SFO', 'modifiers': [{'raw': 'R,25APR18,P'}, {'type': 'travelDates', 'raw': '29JUN18'}]}}]);
        $list.push(['FQDMIABAQ\/05SEP*04OCT'                   , {'type': 'fareSearch', 'data': {'departureAirport': 'MIA', 'destinationAirport': 'BAQ', 'modifiers': [{'type': 'travelDates', 'raw': '05SEP*04OCT'}]}}]);
        $list.push(['FQDNYCPTY\/20DEC*5JAN\/AUA'                , {'type': 'fareSearch', 'data': {'departureAirport': 'NYC', 'destinationAirport': 'PTY', 'modifiers': [{'type': 'travelDates', 'raw': '20DEC*5JAN'}]}}]);
        $list.push(['FQDNYCGYE\/20DEC*5JAN\/AUA'                , {'type': 'fareSearch', 'data': {'departureAirport': 'NYC', 'destinationAirport': 'GYE', 'modifiers': [{'type': 'travelDates', 'raw': '20DEC*5JAN'}]}}]);
        $list.push(['FQDLAXGYE\/18OCT*18FEB'                   , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'GYE', 'modifiers': [{'type': 'travelDates', 'raw': '18OCT*18FEB'}]}}]);
        $list.push(['FQDSFOSYD\/28MAR*11APR\/R,U\/KC'            , {'type': 'fareSearch', 'data': {'departureAirport': 'SFO', 'destinationAirport': 'SYD', 'modifiers': [{'type': 'travelDates', 'raw': '28MAR*11APR'}]}}]);
        $list.push(['FQDSFOSYD\/28MAR*11APR\/R,U\/KC\/AVA'        , {'type': 'fareSearch', 'data': {'departureAirport': 'SFO', 'destinationAirport': 'SYD', 'modifiers': [{'type': 'travelDates', 'raw': '28MAR*11APR'}]}}]);
        $list.push(['FQDSFOSYD\/26DEC*9JAN\/KC\/AVA'             , {'type': 'fareSearch', 'data': {'departureAirport': 'SFO', 'destinationAirport': 'SYD', 'modifiers': [{'type': 'travelDates', 'raw': '26DEC*9JAN'}]}}]);
        $list.push(['FQDSFOSYD\/26DEC*9JAN\/R,U\/KC\/AVA'         , {'type': 'fareSearch', 'data': {'departureAirport': 'SFO', 'destinationAirport': 'SYD', 'modifiers': [{'type': 'travelDates', 'raw': '26DEC*9JAN'}]}}]);
        $list.push(['FQDNYCEDI\/3OCT*8OCT\/AEI'                 , {'type': 'fareSearch', 'data': {'departureAirport': 'NYC', 'destinationAirport': 'EDI', 'modifiers': [{'type': 'travelDates', 'raw': '3OCT*8OCT'}]}}]);
        $list.push(['FQDGYENYC\/8AUG*28AUG'                    , {'type': 'fareSearch', 'data': {'departureAirport': 'GYE', 'destinationAirport': 'NYC', 'modifiers': [{'type': 'travelDates', 'raw': '8AUG*28AUG'}]}}]);
        $list.push(['FQDLIMCMH\/22AUG*26SEP'                   , {'type': 'fareSearch', 'data': {'departureAirport': 'LIM', 'destinationAirport': 'CMH', 'modifiers': [{'type': 'travelDates', 'raw': '22AUG*26SEP'}]}}]);
        $list.push(['FQDSFOMNL\/17JUN18\/R,17OCT17\/APR\/IR\/CE'   , {'type': 'fareSearch', 'data': {'departureAirport': 'SFO', 'destinationAirport': 'MNL', 'modifiers': [{'type': 'travelDates', 'raw': '17JUN18'}]}}]);
        $list.push(['FQDLAXSGN\/03DEC\/R,01JUN18,P\/AHX\/IR\/CW'   , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'SGN', 'modifiers': [{'type': 'travelDates', 'raw': '03DEC'}]}}]);
        $list.push(['FQDIADMAN\/18OCT\/AEI'                     , {'type': 'fareSearch', 'data': {'departureAirport': 'IAD', 'destinationAirport': 'MAN', 'modifiers': [{'type': 'travelDates', 'raw': '18OCT'}]}}]);
        $list.push(['FQDBDLLON\/20SEP\/AEI\/IO\/CW'               , {'type': 'fareSearch', 'data': {'departureAirport': 'BDL', 'destinationAirport': 'LON', 'modifiers': [{'type': 'travelDates', 'raw': '20SEP'}]}}]);
        $list.push(['FQDBDLLON\/20SEP\/AEI\/IO'                  , {'type': 'fareSearch', 'data': {'departureAirport': 'BDL', 'destinationAirport': 'LON', 'modifiers': [{'type': 'travelDates', 'raw': '20SEP'}]}}]);
        $list.push(['FQDLAXACC\/10SEP\/R,-JCB\/AET\/IO'           , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'ACC', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDLAXACC\/10SEP\/AET\/IO'                  , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'ACC', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDLAXACC\/10SEP\/R,U\/AET\/IO'              , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'ACC', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDLAXACC\/10SEP\/R,U\/AET'                 , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'ACC', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDLAXACC\/10SEP\/AET'                     , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'ACC', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDLOSLAX\/1OCT\/IO\/R,UP'                  , {'type': 'fareSearch', 'data': {'departureAirport': 'LOS', 'destinationAirport': 'LAX', 'modifiers': [{'type': 'travelDates', 'raw': '1OCT'}]}}]);
        $list.push(['FQDLOSLAX\/20SEP\/R,-JCB\/AET'              , {'type': 'fareSearch', 'data': {'departureAirport': 'LOS', 'destinationAirport': 'LAX', 'modifiers': [{'type': 'travelDates', 'raw': '20SEP'}]}}]);
        $list.push(['FQDLOSLAX\/20SEP\/AET'                     , {'type': 'fareSearch', 'data': {'departureAirport': 'LOS', 'destinationAirport': 'LAX', 'modifiers': [{'type': 'travelDates', 'raw': '20SEP'}]}}]);
        $list.push(['FQDLOSLAX\/1OCT\/IO\/R+UO'                  , {'type': 'fareSearch', 'data': {'departureAirport': 'LOS', 'destinationAirport': 'LAX', 'modifiers': [{'type': 'travelDates', 'raw': '1OCT'}]}}]);
        $list.push(['FQDLOSLAX\/1OCT\/IO'                       , {'type': 'fareSearch', 'data': {'departureAirport': 'LOS', 'destinationAirport': 'LAX', 'modifiers': [{'type': 'travelDates', 'raw': '1OCT'}]}}]);
        $list.push(['FQDMCOSCL\/15JUL18\/R,06JUL18,P\/ALA\/IR\/CL' , {'type': 'fareSearch', 'data': {
        ...
        $list.push(['FQDSFOMEL\/19FEB\/AVA\/R,U'                 , {'type': 'fareSearch', 'data': {'departureAirport': 'SFO', 'destinationAirport': 'MEL', 'modifiers': [{'type': 'travelDates', 'raw': '19FEB'}]}}]);
        $list.push(['FQDSFOMEL\/19FEB\/ANZ\/R,U'                 , {'type': 'fareSearch', 'data': {'departureAirport': 'SFO', 'destinationAirport': 'MEL', 'modifiers': [{'type': 'travelDates', 'raw': '19FEB'}]}}]);
        $list.push(['FQDWASMNL\/10SEP\/R,U'                     , {'type': 'fareSearch', 'data': {'departureAirport': 'WAS', 'destinationAirport': 'MNL', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDWASCMN\/10SEP\/R,U'                     , {'type': 'fareSearch', 'data': {'departureAirport': 'WAS', 'destinationAirport': 'CMN', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDLONWAS\/10SEP\/R,U'                     , {'type': 'fareSearch', 'data': {'departureAirport': 'LON', 'destinationAirport': 'WAS', 'modifiers': [{'type': 'travelDates', 'raw': '10SEP'}]}}]);
        $list.push(['FQDSYDSJC\/19AUG18\/R,25JUL18,U\/AVA\/IR'    , {'type': 'fareSearch', 'data': {'departureAirport': 'SYD', 'destinationAirport': 'SJC', 'modifiers': [{'type': 'travelDates', 'raw': '19AUG18'}]}}]);
        $list.push(['FQDSYDSJC\/19AUG\/AVA\/R,U+-ITX'            , {'type': 'fareSearch', 'data': {'departureAirport': 'SYD', 'destinationAirport': 'SJC', 'modifiers': [{'type': 'travelDates', 'raw': '19AUG'}]}}]);
        $list.push(['FQDLAXAKL\/17SEP\/AVA\/R,P'                 , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'AKL', 'modifiers': [{'type': 'travelDates', 'raw': '17SEP'}]}}]);
        $list.push(['FQDLAXAKL\/17SEP\/AVA\/R,U'                 , {'type': 'fareSearch', 'data': {'departureAirport': 'LAX', 'destinationAirport': 'AKL', 'modifiers': [{'type': 'travelDates', 'raw': '17SEP'}]}}]);
        $list.push(['FQDSYDSJC\/19AUG\/AVA\/R,IT'                , {'type': 'fareSearch', 'data': {'departureAirport': 'SYD', 'destinationAirport': 'SJC', 'modifiers': [{'type': 'travelDates', 'raw': '19AUG'}]}}]);
        $list.push(['FQDKIVRIX\/20SEP\/APS,TK,LO\/IR', {'type': 'fareSearch', 'data': {
        ...
        $list.push(['FQDKIVRIX\/20SEP\/A9U,PS\/KF', {'type': 'fareSearch', 'data': {
            'departureAirport': 'KIV',
            'destinationAirport': 'RIX',
            'modifiers': [
                {'type': 'travelDates', 'raw': '20SEP'},
