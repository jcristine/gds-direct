...
const provide_parseXml = () => {
	...
	list.push({
		...
		output: {
			errors: null,
			dump: 'Something Something2 Something3',
		},
	});
	...
	list.push({
		...
		output: {
			errors: ['Service returned error response', '<SubmitXmlOnSessionResult><FareQuoteMultiDisplay_23 xmlns=""></FareQuoteMultiDisplay_23></SubmitXmlOnSessionResult>'],
			dump: null,
		},
	});
