	...
	list.push({
		...
		httpRequests: [{
			rq: [
				...
				'    </ebmsg:MessageHeader>',
				'  </SOAP-ENV:Header>',
				'  <SOAP-ENV:Body><ns1:EnhancedAirBookRQ version="3.9.0" xmlns:ns1="http://services.sabre.com/sp/eab/v3_9"><ns1:OTA_AirBookRQ><ns1:OriginDestinationInformation><ns1:FlightSegment DepartureDateTime="2020-05-20T00:00" FlightNumber="127" NumberInParty="1" ResBookDesigCode="C" Status="GK"><ns1:DestinationLocation LocationCode="MNL"/><ns1:MarketingAirline Code="PR" FlightNumber="127"/><ns1:MarriageGrp>O</ns1:MarriageGrp><ns1:OperatingAirline Code="PR"/><ns1:OriginLocation LocationCode="JFK"/></ns1:FlightSegment><ns1:FlightSegment DepartureDateTime="2020-05-25T00:00" FlightNumber="126" NumberInParty="1" ResBookDesigCode="C" Status="GK"><ns1:DestinationLocation LocationCode="JFK"/><ns1:MarketingAirline Code="PR" FlightNumber="126"/><ns1:MarriageGrp>O</ns1:MarriageGrp><ns1:OperatingAirline Code="PR"/><ns1:OriginLocation LocationCode="MNL"/></ns1:FlightSegment></ns1:OriginDestinationInformation></ns1:OTA_AirBookRQ><ns1:PostProcessing/><ns1:PreProcessing/></ns1:EnhancedAirBookRQ>  </SOAP-ENV:Body>',
				'</SOAP-ENV:Envelope>',
			].join('\n'),
