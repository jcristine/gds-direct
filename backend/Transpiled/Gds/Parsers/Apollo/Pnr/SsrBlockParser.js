...
class SsrBlockParser
{
    ...
    static parseSsrDocsLine($line)  {
        let $paxNumTokens, $paxNum, $paxInf, $documentInfo, $paxName, $pre, $travelDocType, $issuingCountry, $travelDocNumber, $nationality, $dob, $gender, $expirationDate, $lastName, $firstName, $middleName, $primaryPassportHolderToken, $parsedExpirationDate;
    ...
    static parseSsrDocaLine($line)  {
        let $paxNumTokens, $paxNum, $paxInf, $documentInfo, $paxName, $pre, $addressType, $country, $addressDetails, $city, $province, $postalCode;
    ...
    static parseSsrDocoLine($line)  {
        let $paxNumTokens, $paxNum, $paxInf, $documentInfo, $paxName, $pre, $placeOfBirth, $travelDocType, $travelDocNumber, $issuingCountry, $dateOfBirth, $countryWhereApplies;
