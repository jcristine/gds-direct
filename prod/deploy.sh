...
# timeout 30s firefox "https://gds-direct-plus.asaptickets.com/server/restartIfNeeded?password=28145f8f7e54a60d2c3905edcce2dabb&message=restart-rq-from-deploy-script-after-rsync" &
